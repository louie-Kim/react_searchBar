...
import { setSearchResults } from './redux/PostSlice'
...
const SearchBar = () => {
  ...
  const handleSearchChange = (e) =>{
    ...
    const resultArray = posts.filter(post => {
      ...
      console.log("titleNoSpaces.includes(searchTerm)",titleNoSpaces.includes(searchTerm)); // true -> false(입력이 멈출때?)
      ...
      dispatch(setSearchResults(resultArray))
  }      
